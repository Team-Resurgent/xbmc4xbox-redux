...
namespace XFILE
{
  namespace PROGRAMDATABASEDIRECTORY
  {
    ...
    typedef enum _NODE_TYPE
    {
      ...
      NODE_TYPE_GENERALFEATURE,
      NODE_TYPE_GAMES_OVERVIEW,
      NODE_TYPE_APPS_OVERVIEW,
      NODE_TYPE_GENRE,
      NODE_TYPE_ONLINEFEATURE,
      NODE_TYPE_PLATFORM,
      NODE_TYPE_PUBLISHER,
      NODE_TYPE_ROOT,
      NODE_TYPE_OVERVIEW,
      NODE_TYPE_TITLE_GAMES,
      NODE_TYPE_TITLE_APPS,
      NODE_TYPE_YEAR,
      NODE_TYPE_RECENTLY_ADDED_GAMES,
      NODE_TYPE_RECENTLY_PLAYED_GAMES,
      NODE_TYPE_TAGS,
    } NODE_TYPE;
